...
Projektet ska vara inlämnat senast kl.23:59 på söndag v.3. Allt kod och dokumentation ska ingå i din forkad repo. Under vecka 4 kommer ni att examineras muntligt där ni förväntas kunna förklara dina kod.
## Betygsättning

Allmänt sätt är det skolverkets kunskapskrav som gäller för betygsättning i detta projekt. Hänsyn tas till exempel till programmets komplexitet, användning av arv och polymorfi, konsekvent kodningsstil, stabilitet med mera. 

För betyget E och C krävs endast att programmet är konsolbaserat. För betyget A måste både ett konsolbaserat program och en grafisk variant tas fram. Dessa får förstås dela kod, klasser med mera. En klass diagram över den grafiska behövs ej.
